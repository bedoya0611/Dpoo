...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoListaInvertida() {
        ...
        for (String cadena : conjuntoInvertido) {
            listaInvertida.add(cadena);
        }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas(String cadena) {
        if (arbolCadenas != null && cadena != null) {
    ...
    public void volverMayusculas() {
        if (arbolCadenas != null) {
            NavigableSet<String> cadenasEnMayusculas = new TreeSet<>();
            for (String cadena : arbolCadenas) {
                cadenasEnMayusculas.add(cadena.toUpperCase());
            }
            arbolCadenas = cadenasEnMayusculas;
        }
    }
    ...
    public boolean compararElementos(String[] otroArreglo) {
        if (arbolCadenas == null || otroArreglo == null) {
            return false;
        }
