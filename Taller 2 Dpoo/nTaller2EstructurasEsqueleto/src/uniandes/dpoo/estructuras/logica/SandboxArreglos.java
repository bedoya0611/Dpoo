...
public class SandboxArreglos
{
    ...
    public void agregarCadena(String cadena) {
        if (arregloCadenas == null || arregloCadenas.length == 0) {
            arregloCadenas = new String[] {cadena};
        } else {
    ...
    public int contarEnterosRepetidos() {
        ...
        boolean enSecuenciaRepetida = false;

        for (int i = 0; i < arregloEnteros.length - 1; i++) {
            if (arregloEnteros[i] == arregloEnteros[i + 1]) {
                if (!enSecuenciaRepetida) {
                    totalRepetidos++;
                    enSecuenciaRepetida = true;
                }
            } else {
                enSecuenciaRepetida = false;
            }
        }
    ...
    public boolean mismosEnteros(int[] otroArreglo) {
        ...
        for (int i = 0; i < arregloEnteros.length; i++) {
            ...
            int conteoArreglo1 = 0;
            int conteoArreglo2 = 0;
            ...
            for (int j = 0; j < otroArreglo.length; j++) {
                if (otroArreglo[j] == valor) {
                    conteoArreglo2++;
                }
            }
            if (conteoArreglo1 != conteoArreglo2) {
                return false;
            }
        }
        return true;
    ...
    public void generarEnteros(int cantidad, int minimo, int maximo) {
        ...
        for (int i = 0; i < cantidad; i++) {
            int numeroAleatorio = minimo + (int)(Math.random() * rango);
