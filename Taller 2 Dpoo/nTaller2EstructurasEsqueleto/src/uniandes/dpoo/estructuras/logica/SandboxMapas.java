...
public class SandboxMapas
{
    ...
    public void eliminarCadenaConValor(String valor) {
        ...
        for (Map.Entry<String, String> entrada : mapaCadenas.entrySet()) {
            if (entrada.getValue().equals(valor)) {
                llaveParaEliminar = entrada.getKey();
                break;
            }
        }
    ...
    public void reiniciarMapaCadenas(List<Object> objetos) {
        ...
        for (Object obj : objetos) {
            String representacionString = obj.toString();
            mapaCadenas.put(representacionString, representacionString);
        }
    }
    ...
    public void volverMayusculas() {
        ...
        for (Map.Entry<String, String> entrada : mapaCadenas.entrySet()) {
            mapaTemporal.put(entrada.getKey().toUpperCase(), entrada.getValue());
        }

        mapaCadenas = mapaTemporal;
    }
